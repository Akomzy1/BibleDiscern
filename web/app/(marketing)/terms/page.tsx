...
export const metadata: Metadata = {
  title: 'Terms of Service — LibratoAi',
  description: 'LibratoAi terms of service. Review the terms governing use of the LibratoAi app and website.',
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-14 prose prose-lg text-text-dark">
        <p className="lead text-text-medium">
          By using LibratoAi, you agree to these terms. Please read them carefully.
        </p>

        <h2 className="font-display text-navy">1. Acceptance of Terms</h2>
        <p>By downloading, installing, or using the LibratoAi mobile application or website, you agree to be bound by these Terms of Service. If you do not agree, do not use the service.</p>

        <h2 className="font-display text-navy">2. Description of Service</h2>
        <p>LibratoAi is an AI-powered Christian discernment companion application. The service provides structured biblical guidance for personal decision-making, drawing on Scripture, Christian tradition, and AI technology.</p>
        <p><strong>Important:</strong> LibratoAi is a spiritual reflection tool. It does not provide professional counseling, medical advice, legal advice, or financial advice. It does not replace the guidance of a pastor, spiritual director, therapist, or other qualified professional. For crisis situations, please contact emergency services (911 in the US) or the 988 Suicide and Crisis Lifeline.</p>

        <h2 className="font-display text-navy">3. User Accounts</h2>
        <p>You must create an account to use LibratoAi. You are responsible for maintaining the security of your account credentials and for all activities that occur under your account. You must be at least 13 years of age to create an account.</p>

        <h2 className="font-display text-navy">4. Subscriptions and Billing</h2>
        <p>LibratoAi offers a free plan and a Premium subscription. Premium subscriptions are billed through the Apple App Store or Google Play Store, subject to their respective terms. We also offer web-based subscriptions through Stripe.</p>
        ...
        <ul>
          <li>Use LibratoAi for any unlawful purpose</li>
        ...
        <p>LibratoAi's responses are generated by AI and are provided for reflection and discernment purposes only. They do not constitute definitive divine guidance, prophetic utterance, or professional advice of any kind. You are solely responsible for any decisions you make, and LibratoAi expressly disclaims any liability for the outcomes of your decisions.</p>
        ...
        <p>The LibratoAi app, its design, and its underlying code are owned by LibratoAi and protected by applicable intellectual property laws. The content of your discernment sessions belongs to you. By using the service, you grant LibratoAi a limited license to store and process your content for the purpose of providing the service.</p>

        <h2 className="font-display text-navy">8. Disclaimer of Warranties</h2>
        <p>LibratoAi is provided "as is" and "as available" without warranties of any kind, express or implied. We do not warrant that the service will be uninterrupted, error-free, or free of harmful components.</p>

        <h2 className="font-display text-navy">9. Limitation of Liability</h2>
        <p>To the maximum extent permitted by law, LibratoAi shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service. Our total liability to you shall not exceed the amount you paid for the service in the 12 months preceding the claim.</p>
