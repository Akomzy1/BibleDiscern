...
## Tags
Christianity, Bible, Prayer, Spiritual Growth, Decision Making
...
★ THE WORD — Receive curated Scripture and a Biblical Narrative Match (which figure in Scripture faced something similar?)

★ THE TRADITION — Explore how the Church has historically approached decisions like yours

★ THE REASON — Work through the practical dimensions: pros, cons, what each path requires

★ THE COMMUNITY — Be reminded of the voices in your life who should speak into this decision

★ THE STILLNESS — A 90-second guided contemplative pause (1 Kings 19:12 — "a still, small voice")

★ THE PRAYER — Receive a fully personalized prayer written around your specific situation
...
Premium users receive a Fruit of the Spirit lens — love, joy, peace, patience, kindness, goodness, faithfulness, gentleness, self-control — applied to their specific decision with Scripture references for each fruit.

**THE SPIRITUAL JOURNAL**

Every session is saved as an Ebenezer stone — "Thus far the Lord has helped us" (1 Samuel 7:12). Return to see how past decisions unfolded. Premium users receive follow-up reminders at 1 week, 1 month, and 3 months.

**THE DAILY MOMENT**

Each morning, a brief Scripture reflection delivered as a notification — a quiet anchor before the day begins.
...
- Paid App: No (free to download, with in-app subscription)
...
Crisis safety: The app includes crisis detection that shows a dedicated screen with crisis resources (988 Suicide and Crisis Lifeline, Crisis Text Line) when concerning language is detected in user input.

In-app subscriptions use Google Play Billing via RevenueCat.

Deep linking is configured for https://librato.ai/discern/*, /journal/*, and /upgrade paths.
